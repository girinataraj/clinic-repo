...
import { Home, Calendar, FileText, User, Users, ClipboardList, BarChart2, UserCog, Activity, FileSearch } from 'lucide-react';
...
const navConfig: Record<string, NavItem[]> = {
  ...
  doctor: [
    ...
    { label: 'Staff', Icon: UserCog, path: '/doctor/staff' },
