...
export const doctorInputClass = "w-full outline-none px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:border-[#262842] focus:ring-1 focus:ring-[#262842] transition-colors";
...
export function ToggleChip({ label, checked, onChange, accent = 'teal' }: {
  ...
  return (
    <button type="button" onClick={onChange}
      ...
      <div className={`w-[18px] h-[18px] rounded border-2 flex items-center justify-center shrink-0 ${checked ? checkBg : 'bg-white dark:bg-slate-900 border-slate-300 dark:border-slate-600'}`}>
